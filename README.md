...
[Проект](https://github.com/Walleclipse/Deep_Speaker-speaker_recognition_system)
 который работает так:  
 1) использует рекуррентную нейронную сеть  
 2) не преобразует герцы в мелы  
 3) содержит инструмент для конвертации flac в wav  
 4) данные должны быть в wav формате  
